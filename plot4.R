...
#file to create time 2x2 matrix f charts
...
#plot 4
tPath<-file.path(fPath,"plot4.png")
png(tPath)
par(mfcol=c(2,2))
plot(hpcdata$Time,hpcdata$Global_active_power,type = "l",ylab = "Global Active Power",xlab="")
...
plot(hpcdata$Time,hpcdata$Global_reactive_power,type = "l",xlab = "datetime",ylab = "Global_Reactive_Power")
dev.off()
